...
class ProductAction(object):
    ...
    def _admin_product_sync(self, skuCodes_=None, type_=None):
        if self.user is None:
            data = {'skuCodes': skuCodes_, 'type': type_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'skuCodes': skuCodes_, 'type': type_}
        response = self.request.post(url=self.url+'/admin/product/sync', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))
    ...
    def _admin_sku_edit(self, code_=None, name_=None, alias_=None, brandId_=None, basicCost_=None, minimumPrice_=None, marketPrice_=None, validity_=None, validityUnit_=None, netWeight_=None, grossWeight_=None, baseUnit_=None, isSale_=None, airTransport_=None, basicAttr_=None, saleAttr_=None, length_=None, width_=None, height_=None, volume_=None, barCode_=None, batchMnt_=None, oemProduction_=None, inventoryUnit_=None, purchaseUnit_=None, salesUnit_=None, salesUnitQuantity_=None, purchase_unit_quantity_=None, relatedSkuCode_=None, purchaseTaxId_=None, salesTaxId_=None, accessoryCost_=None, productType_=None, skuRelatedStr_=None):
        if self.user is None:
            data = {'code': code_, 'name': name_, 'alias': alias_, 'brandId': brandId_, 'basicCost': basicCost_, 'minimumPrice': minimumPrice_, 'marketPrice': marketPrice_, 'validity': validity_, 'validityUnit': validityUnit_, 'netWeight': netWeight_, 'grossWeight': grossWeight_, 'baseUnit': baseUnit_, 'isSale': isSale_, 'airTransport': airTransport_, 'basicAttr': basicAttr_, 'saleAttr': saleAttr_, 'length': length_, 'width': width_, 'height': height_, 'volume': volume_, 'barCode': barCode_, 'batchMnt': batchMnt_, 'oemProduction': oemProduction_, 'inventoryUnit': inventoryUnit_, 'purchaseUnit': purchaseUnit_, 'salesUnit': salesUnit_, 'salesUnitQuantity': salesUnitQuantity_, 'purchase_unit_quantity': purchase_unit_quantity_, 'relatedSkuCode': relatedSkuCode_, 'purchaseTaxId': purchaseTaxId_, 'salesTaxId': salesTaxId_, 'accessoryCost': accessoryCost_, 'productType': productType_, 'skuRelatedStr': skuRelatedStr_, }
        else:
