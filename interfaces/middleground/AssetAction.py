...
class assetAction(object):
    ...
    def _admin_goods_apply_apply(self, dictCode_=None, dictKey_=None, total_=None, applicantId_=None, applicantSource_=None):
        if self.user is None:
            data = {'dictCode': dictCode_, 'dictKey': dictKey_, 'total': total_, 'applicantId': applicantId_, 'applicantSource': applicantSource_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'dictCode': dictCode_, 'dictKey': dictKey_, 'total': total_, 'applicantId': applicantId_, 'applicantSource': applicantSource_}
    ...
    def _admin_sys_dict_list(self, dictCode_=None):
        if self.user is None:
