...
class BeeAction(object):
    ...
    def _admin_bee_friend_collection_collection_phone(self, startDate_=None, endDate_=None):
    ...
    def _admin_bee_friend_edit(self, regularSource_=None, labelType_=None, intention_=None, id_=None, realName_=None, keeperName_=None, contactNumber_=None, gender_=None, nativeProvince_=None, nativeCity_=None, nativeCounty_=None, age_=None, seniority_=None, regularRoute_=None, studyFrom_=None, heir_=None, yield_=None, income_=None, breedTime1_=None, breedPlace1_=None, breedTime2_=None, breedPlace2_=None, saleNum_=None, intentionPrice_=None, saleTime_=None, saleProvince_=None, saleCity_=None, saleCounty_=None):
        if self.user is None:
            data = {'regularSource': regularSource_, 'labelType': labelType_, 'intention': intention_, 'id': id_, 'realName': realName_, 'keeperName': keeperName_, 'contactNumber': contactNumber_, 'gender': gender_, 'nativeProvince': nativeProvince_, 'nativeCity': nativeCity_, 'nativeCounty': nativeCounty_, 'age': age_, 'seniority': seniority_, 'regularRoute': regularRoute_, 'studyFrom': studyFrom_, 'heir': heir_, 'yield': yield_, 'income': income_, 'breedTime1': breedTime1_, 'breedPlace1': breedPlace1_, 'breedTime2': breedTime2_, 'breedPlace2': breedPlace2_, 'saleNum': saleNum_, 'intentionPrice': intentionPrice_, 'saleTime': saleTime_, 'saleProvince': saleProvince_, 'saleCity': saleCity_, 'saleCounty': saleCounty_, }
        else:
    ...
    def _admin_bee_friend_page_list(self, businessLabels_=None, pn_=None, ps_=None, searchKey_=None, province_=None, city_=None, county_=None, collectTimeStart_=None, collectTimeEnd_=None, collector_=None, locOrderType_=None, ctOrderType_=None, registed_=None):
        if self.user is None:
            data = {'businessLabels': businessLabels_, 'pn': pn_, 'ps': ps_, 'searchKey': searchKey_, 'province': province_, 'city': city_, 'county': county_, 'collectTimeStart': collectTimeStart_, 'collectTimeEnd': collectTimeEnd_, 'collector': collector_, 'locOrderType': locOrderType_, 'ctOrderType': ctOrderType_, 'registed': registed_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'businessLabels': businessLabels_, 'pn': pn_, 'ps': ps_, 'searchKey': searchKey_, 'province': province_, 'city': city_, 'county': county_, 'collectTimeStart': collectTimeStart_, 'collectTimeEnd': collectTimeEnd_, 'collector': collector_, 'locOrderType': locOrderType_, 'ctOrderType': ctOrderType_, 'registed': registed_}
    ...
    def _admin_dashboard_friend_phone(self, startDate_=None, endDate_=None):
        if self.user is None:
            data = {'startDate': startDate_, 'endDate': endDate_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'startDate': startDate_, 'endDate': endDate_}
        response = self.request.post(url=self.url+'/admin/dashboard/friend-phone', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _admin_dashboard_friend_source(self, startDate_=None, endDate_=None):
        if self.user is None:
            data = {'startDate': startDate_, 'endDate': endDate_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'startDate': startDate_, 'endDate': endDate_}
        response = self.request.post(url=self.url+'/admin/dashboard/friend-source', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _admin_dashboard_friend_swarm(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/admin/dashboard/friend-swarm', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _admin_dashboard_history_generate(self, startDate_=None, endDate_=None):
        if self.user is None:
            data = {'startDate': startDate_, 'endDate': endDate_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'startDate': startDate_, 'endDate': endDate_}
        response = self.request.post(url=self.url+'/admin/dashboard/history-generate', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _admin_dashboard_incr_swarm(self, startDate_=None, endDate_=None):
        if self.user is None:
            data = {'startDate': startDate_, 'endDate': endDate_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'startDate': startDate_, 'endDate': endDate_}
        response = self.request.post(url=self.url+'/admin/dashboard/incr-swarm', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _admin_dashboard_overview(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/admin/dashboard/overview', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))
    ...
    def _admin_excel_export_bee_friend(self, businessLabels_=None, pn_=None, ps_=None, searchKey_=None, province_=None, city_=None, county_=None, collectTimeStart_=None, collectTimeEnd_=None, collector_=None, locOrderType_=None, ctOrderType_=None, registed_=None):
        if self.user is None:
            data = {'businessLabels': businessLabels_, 'pn': pn_, 'ps': ps_, 'searchKey': searchKey_, 'province': province_, 'city': city_, 'county': county_, 'collectTimeStart': collectTimeStart_, 'collectTimeEnd': collectTimeEnd_, 'collector': collector_, 'locOrderType': locOrderType_, 'ctOrderType': ctOrderType_, 'registed': registed_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'businessLabels': businessLabels_, 'pn': pn_, 'ps': ps_, 'searchKey': searchKey_, 'province': province_, 'city': city_, 'county': county_, 'collectTimeStart': collectTimeStart_, 'collectTimeEnd': collectTimeEnd_, 'collector': collector_, 'locOrderType': locOrderType_, 'ctOrderType': ctOrderType_, 'registed': registed_}
    ...
    def _admin_excel_export_nectar_source(self, excludeStatus_=None, includeStatus_=None, includeProvince_=None, includeCity_=None, includeType_=None, pn_=None, ps_=None, province_=None, city_=None, county_=None, searchName_=None, searchFlowerStart_=None, searchFlowerEnd_=None, collectTimeStart_=None, collectTimeEnd_=None, collector_=None, vehicleLength_=None, ctOrderType_=None, isEnter_=None):
        if self.user is None:
            data = {'excludeStatus': excludeStatus_, 'includeStatus': includeStatus_, 'includeProvince': includeProvince_, 'includeCity': includeCity_, 'includeType': includeType_, 'pn': pn_, 'ps': ps_, 'province': province_, 'city': city_, 'county': county_, 'searchName': searchName_, 'searchFlowerStart': searchFlowerStart_, 'searchFlowerEnd': searchFlowerEnd_, 'collectTimeStart': collectTimeStart_, 'collectTimeEnd': collectTimeEnd_, 'collector': collector_, 'vehicleLength': vehicleLength_, 'ctOrderType': ctOrderType_, 'isEnter': isEnter_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'excludeStatus': excludeStatus_, 'includeStatus': includeStatus_, 'includeProvince': includeProvince_, 'includeCity': includeCity_, 'includeType': includeType_, 'pn': pn_, 'ps': ps_, 'province': province_, 'city': city_, 'county': county_, 'searchName': searchName_, 'searchFlowerStart': searchFlowerStart_, 'searchFlowerEnd': searchFlowerEnd_, 'collectTimeStart': collectTimeStart_, 'collectTimeEnd': collectTimeEnd_, 'collector': collector_, 'vehicleLength': vehicleLength_, 'ctOrderType': ctOrderType_, 'isEnter': isEnter_}
    ...
    def _admin_index_position_data(self, dataTypes_=None, stDate_=None, edDate_=None, vehicle_=None, stHiveNum_=None, edHiveNum_=None, nectarType_=None, provinces_=None, cities_=None, counties_=None):
        if self.user is None:
            data = {'dataTypes': dataTypes_, 'stDate': stDate_, 'edDate': edDate_, 'vehicle': vehicle_, 'stHiveNum': stHiveNum_, 'edHiveNum': edHiveNum_, 'nectarType': nectarType_, 'provinces': provinces_, 'cities': cities_, 'counties': counties_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'dataTypes': dataTypes_, 'stDate': stDate_, 'edDate': edDate_, 'vehicle': vehicle_, 'stHiveNum': stHiveNum_, 'edHiveNum': edHiveNum_, 'nectarType': nectarType_, 'provinces': provinces_, 'cities': cities_, 'counties': counties_}
    ...
    def _admin_swarm_collection_list(self, countTime_=None):
        if self.user is None:
            data = {'countTime': countTime_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'countTime': countTime_}
        response = self.request.post(url=self.url+'/admin/swarm-collection/list', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _admin_swarm_collection_overview(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/admin/swarm-collection/overview', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _admin_swarm_collection_promoter_list(self, countTime_=None, queryCond_=None, amassSort_=None, dayCollectedSort_=None):
        if self.user is None:
            data = {'countTime': countTime_, 'queryCond': queryCond_, 'amassSort': amassSort_, 'dayCollectedSort': dayCollectedSort_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'countTime': countTime_, 'queryCond': queryCond_, 'amassSort': amassSort_, 'dayCollectedSort': dayCollectedSort_}
        response = self.request.post(url=self.url+'/admin/swarm-collection/promoter-list', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))
    ...
    def _api_statistics_generate_bee_friend_collection_history(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/api/statistics/generate/bee-friend-collection/history', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _api_statistics_generate_bee_friend_collection_source(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/api/statistics/generate/bee-friend-collection/source', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _api_statistics_generate_bee_friend_collection_phone(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/api/statistics/generate/bee-friend/collection-phone', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _api_statistics_generate_bee_friend_source(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/api/statistics/generate/bee-friend/source', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _api_statistics_generate_incr_swarm(self, countDays_=None):
        if self.user is None:
            data = {'countDays': countDays_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'countDays': countDays_}
        response = self.request.post(url=self.url+'/api/statistics/generate/incr-swarm', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _api_statistics_generate_promoter_history(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/api/statistics/generate/promoter/history', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _api_statistics_generate_promoter_source(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/api/statistics/generate/promoter/source', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _api_statistics_generate_swarm_collection_history(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/api/statistics/generate/swarm-collection/history', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))

    def _api_statistics_generate_swarm_promoter_history(self):
        if self.user is None:
            data = {}
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id}
        response = self.request.post(url=self.url+'/api/statistics/generate/swarm-promoter/history', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))
    ...
    def _mobile_extract_add(self, nectarSourceId_=None, nectarSourceType_=None, gatherTime_=None, weight_=None, operatorId_=None, unit_=None):
        if self.user is None:
            data = {'nectarSourceId': nectarSourceId_, 'nectarSourceType': nectarSourceType_, 'gatherTime': gatherTime_, 'weight': weight_, 'operatorId': operatorId_, 'unit': unit_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'nectarSourceId': nectarSourceId_, 'nectarSourceType': nectarSourceType_, 'gatherTime': gatherTime_, 'weight': weight_, 'operatorId': operatorId_, 'unit': unit_}
    ...
    def _mobile_extract_edit(self, id_=None, gatherTime_=None, weight_=None, unit_=None, operatorId_=None):
        if self.user is None:
            data = {'id': id_, 'gatherTime': gatherTime_, 'weight': weight_, 'unit': unit_, 'operatorId': operatorId_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'id': id_, 'gatherTime': gatherTime_, 'weight': weight_, 'unit': unit_, 'operatorId': operatorId_}
    ...
    def _mobile_nectar_source_del(self, id_=None):
        if self.user is None:
            data = {'id': id_, }
        else:
            data = {'_tk_': self.user.token, '_deviceId_': self.user.device_id, 'id': id_}
        response = self.request.post(url=self.url+'/mobile/nectar-source/del', data=data, hosts=self.url)
        return self.__judge_response_status(json.loads(response))
