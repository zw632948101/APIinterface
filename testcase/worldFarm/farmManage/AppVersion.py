...
class AppVersion(testCase):
    ...
    def __init__(self, methodName='runTest'):
        super(AppVersion, self).__init__(methodName=methodName)
    ...
    def test_mobile_app_version_add(self):
        ...
        :return:
        """
        register = self.ka._mobile_app_version_add(appId='01', updateType=1,
    ...
    def test_mobile_app_version_get(self):
        ...
        :return:
        """
        register = self.ka._mobile_app_version_get(appId='02')
        self.assertEqual(register['status'], "OK")
